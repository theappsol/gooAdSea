...
function search() {
  ...
  const extensions = {
    'Movies': '(avi|mkv|mov|mp4|mpg|wmv)',
    'Music': '(ac3|flac|m4a|mp3|ogg|wav|wma)',
    'Documents': '(CBZ|CBR|CHM|DOC|DOCX|EPUB|MOBI|ODT|PDF|RTF|FB2|LIT|LRF|PRC|PDB|PML|RB|TCR|CBC|txt)',
    'Images': '(bmp|gif|jpg|png|psd|tif|tiff)',
    'Apps': '(apk|exe|ipa|iso|rar|tar|zip)',
    'Archives': '(apk|exe|iso|rar|tar|zip|7z)'
  }
